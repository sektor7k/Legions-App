...
export default function TopLose(){
    
      const topLoseData = [
        { name: 'APEmove', symbol: 'APE', price: '$0.5409', change: '-27.96%', volume: '$505K' },
        { name: 'APEmove', symbol: 'APE', price: '$0.5409', change: '-27.96%', volume: '$505K' },
      ...
      return (
        ...
        <h2 className="text-white text-xl font-bold mb-4 text-center">TOP LOSE</h2>
            ...
            <tbody>
                {topLoseData.map((item, index) => (
                    <tr key={index} className=" border-gray-800 border-gradient-bottom font-bold h-20">
                        ...
                        <td className="text-red-600 w-1/6">{item.change}</td>
