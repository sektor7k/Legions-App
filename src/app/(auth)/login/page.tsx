            ...
            <div className="flex justify-center items-center md:w-1/2">
                <div className="max-w-md w-full mx-auto  p-4 md:p-8  backdrop-blur-sm border-gradient">
                    ...
                    <div className="my-8" >
                        ...
                        <Button variant={"link"} onClick={() => router.push("/register")} className=" text-gray-300 mt-3">
                            Don&apos;t have an account? Register
                        </Button>
                        <Button variant={"link"} onClick={() => router.push("/forgotpassword")} className=" text-gray-300 mt-3">
                            Forgot password
                        </Button>
